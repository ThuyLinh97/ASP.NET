...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    InteractiveDateComponent.prototype.shouldIgnoreTouch = function () {
        ...
        //  simply don't allow this to happen.
...
/*
to work with TypeScript mixins
NOTE: if super-method fails, should still attempt to apply
*/
...
var DayGrid = /** @class */ (function (_super) {
    ...
    function DayGrid(view) {
        ...
        _this.bottomCoordPadding = 0; //  for extending the hit area for the last row of the coordinate grid
...
var BasicView = /** @class */ (function (_super) {
    ...
    BasicView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        var scrollerHeight;
        var scrollbarWidths;
        //  to give the view some height prior to dayGrid's columns being rendered
...
var DateComponent = /** @class */ (function (_super) {
    ...
    function DateComponent(_view, _options) {
        ...
        // to set options prior to the this.opt calls
        if (_view) {
            _this['view'] = _view;
        }
        if (_options) {
    ...
    DateComponent.prototype.getDayClasses = function (date, noThemeHighlight) {
        ...
        if (!this.dateProfile.activeUnzonedRange.containsDate(date)) {
            ...
            if (view.isDateInOtherMonth(date, this.dateProfile)) { // use DateComponent subclass somehow
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.initialRender = function () {
        ...
        // called immediately, and upon option change.
        //  locale often affects isRTL, so we explicitly listen to that too.
...
var AgendaView = /** @class */ (function (_super) {
    ...
    AgendaView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        //  to give the view some height prior to timeGrid's columns being rendered
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderNowIndicator = function (date) {
        //  if date columns not ready for some reason (scheduler)
    ...
    TimeGridEventRenderer.prototype.assignFgSegHorizontals = function (segs) {
        ...
        for (i = 0; i < segs.length; i++) {
            ...
            if (seg.footprint.eventDef.title && seg.bottom - seg.top < 30) {
                seg.el.addClass('fc-short'); // "condensed" is a better name
            }
        }
    };
